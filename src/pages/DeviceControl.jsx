    ...
    return (
        <div className="m-1 p-4 rounded-lg">
            ...
            <div className="flex gap-2 mb-4">
                <div className="flex gap-2 rounded-2xl bg-white border border-gray-300 shadow-sm p-1.5">
                    <button
                    ...
                    <button
                        ...
                        className={`px-6 py-1.5 w-20 rounded-xl border font-semibold ${
                            activeType === "light"
                                ? "bg-indigo-600 text-white border-indigo-600"
                                : "bg-white text-slate-800 border-slate-300"
                        }`}
            ...
            <div className="flex gap-3">
                ...
                {/* Scheduling */}
                <div className="rounded-2xl border border-gray-200 bg-white p-4 sm:p-6 flex-3">
                    ...
                    <div className="mt-4 rounded-xl border border-dashed border-slate-300 bg-slate-50 p-3 text-sm">
                        ...
                        {hasSchedule ? (
                            ...
                            <div className="text-slate-500">
                                Hiện chưa có lịch hẹn cho {deviceLabel}. Khi bạn đặt lịch, thông tin sẽ hiển thị ở đây
                                và sẽ tự reset nếu bạn bật/tắt ngay.
                            </div>
                        )}
                    </div>
                </div>
