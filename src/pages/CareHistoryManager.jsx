                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        ...
                        <button
                            ...
                            className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 shadow-md transition-all text-sm font-medium"
                        >
                        ...
                        histories.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* CARD */}
                                    <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-5 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow ml-auto md:ml-0">
