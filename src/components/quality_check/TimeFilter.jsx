            ...
            <div className="mt-4 grid grid-cols-1 lg:grid-cols-[1fr_1fr_auto] gap-3 items-end">
                ...
                <div className="flex flex-col lg:flex-row gap-2 lg:justify-end lg:items-end shrink-0">
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center h-11 px-4 rounded-xl bg-white text-slate-700 border border-slate-300 font-medium hover:bg-slate-50 active:bg-slate-100 transition-colors w-full lg:w-auto"
                    >
