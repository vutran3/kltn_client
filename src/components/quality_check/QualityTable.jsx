    ...
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white/90 shadow">
      ...
      >
        <svg
          ...
          aria-hidden="true"
        >
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 9v3m0 3h.01M10.29 3.86l-7.5 12.99A1.5 1.5 0 004.08 19h15.84a1.5 1.5 0 001.29-2.15l-7.5-12.99a1.5 1.5 0 00-2.58 0z" />
        </svg>
        <div className="text-sm leading-relaxed">
          <div className="font-semibold text-base"> Thông tin từ mục “Hỗ trợ cảnh báo sớm”</div>
          <div className="mt-0.5">
            Các gợi ý trong mục này được tạo tự động bởi hệ thống AI để giúp bạn tham khảo nhanh.
            Tuy nhiên, <span className="font-semibold">AI có thể chưa hiểu hết tình huống thực tế</span>,
            vì vậy bạn <span className="font-semibold">nên kiểm tra lại và trao đổi với chuyên gia</span> trước khi áp dụng.
            <br />
             Hãy xem đây là <span className="italic">ý kiến hỗ trợ</span>, không phải kết luận cuối cùng.
          </div>
        </div>
      </div>
                ...
                <td className="px-3 py-3">
                  <div className="rounded-xl border border-slate-200 bg-white px-3 py-2 leading-relaxed text-slate-700">
                    ...
                    <div className="mt-2 text-xs text-yellow-700/90">
                      ⚠️ Gợi ý tham khảo. Hãy kiểm tra thực tế & hỏi chuyên gia trước khi áp dụng.
                    </div>
                  </div>
                </td>
              </tr>
