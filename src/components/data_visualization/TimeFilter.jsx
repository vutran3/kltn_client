            ...
            <div className="lg:col-span-2">
                <div className="flex gap-2">
                    <button
                        ...
                        className="flex-1 inline-flex items-center justify-center h-11 px-4 rounded-xl bg-sky-600 text-white font-medium shadow-sm hover:bg-sky-700 active:bg-sky-800 transition-colors"
                    >
                    ...
                    <button
                        ...
                        className="flex-1 inline-flex items-center justify-center h-11 px-4 rounded-xl bg-white text-slate-700 border border-slate-300 font-medium hover:bg-slate-50 active:bg-slate-100 transition-colors"
                    >
